            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        ...
                        <br>
                        <div class="row align-items-center">
                            @if(Auth::guard('admin')->user()->hasPermission('teams-create'))
                            <div class="text-center">
                                <!-- Large modal -->
                                <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fas fa-plus-circle"></i> إضافة عضو فريق عمل</button>
                            </div>
                            @endif
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myLargeModalLabel" style="font-family: cairo;">إضافة عضو فريق عمل جديد</h5>
                            ...
                            <div class="card m-b-30">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(Auth::guard('admin')->user()->hasPermission('teams-update'))
                                            <a href="{{route('team.edit',$item->id)}}"><button type="button"  class="float-left btn btn-info" data-size="sm" title="Edit"><i class="fa fa-edit"></i></button></a>
                                            @endif
                                            &ensp;
                                            @if(Auth::guard('admin')->user()->hasPermission('teams-delete'))
                                            <form class="float-left ml-1" action="{{route('team.destroy',$item->id)}}" method="POST">
                                                @csrf
                                                @method('delete')
