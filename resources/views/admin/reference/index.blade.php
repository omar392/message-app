        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title" style="font-family: cairo;">المراجع</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="{{ route('adminhome') }}">الرئيسية</a></li>
                            <li class="breadcrumb-item active">المراجع</li>
                        </ol>
                    </div>
                </div> <!-- end row -->
                <br>
                <div class="row align-items-center">
                    @if(Auth::guard('admin')->user()->hasPermission('references-create'))
                    <div class="text-center">
                        <!-- Large modal -->
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                            data-target=".bs-example-modal-lg"><i class="fas fa-plus-circle"></i>إضافة مرجع </button>
                    </div>
                    @endif
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title mt-0" id="myLargeModalLabel" style="font-family: cairo;">إضافة مرجع جديد</h5>
                                ...
                                <div class="modal-body">
                                    <div class="card-body">
                                        <form action="{{ route('reference.store') }}" method="POST"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="url"
                                                        id="example-text-input" placeholder="الرابط" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input"
                                            ...
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Dedcription</label>
                                                <div class="col-sm-10">
                                    ...
                                    <tbody>
                                        @foreach ($reference as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if(Auth::guard('admin')->user()->hasPermission('references-update'))
                                                    <a href="{{ route('reference.edit', $item->id) }}"><button type="button"
                                                            class="float-left btn btn-info" data-size="sm" title="Edit"><i
                                                                class="fa fa-edit"></i></button></a>
                                                    @endif
                                                    &ensp;
                                                    @if(Auth::guard('admin')->user()->hasPermission('references-delete'))
                                                    <form class="float-left ml-1"
                                                    action="{{ route('reference.destroy', $item->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
