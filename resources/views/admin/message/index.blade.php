        ...
        <div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title" style="font-family: cairo;">الرسائل</h4>
                    </div>
                    <div class="col-sm-6">
                ...
                <br>
                <div class="row align-items-center">
                    @if (Auth::guard('admin')->user()->hasPermission('messages-create'))
                                        ...
                                        <form action="{{ route('message.store') }}" method="POST"
                                            ...
                                            <div class="form-group row">
                                                <label for="example-text-input"
                                                    class="col-sm-2 col-form-label">عنوان الرسالة</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="title_ar"
                                                        id="example-text-input" placeholder="عنوان الرسالة " required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input"
                                                    class="col-sm-2 col-form-label">Message Title</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">محتوى الرسالة</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" name="message_ar"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">Message Content</label>
                                                <div class="col-sm-10">
                                    ...
                                    <tbody>
                                        @foreach ($message as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (Auth::guard('admin')->user()->hasPermission('messages-update'))
                                                    ...
                                                    @endif
                                                    &ensp;
                                                    @if (Auth::guard('admin')->user()->hasPermission('messages-delete'))
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title mt-0" id="myLargeModalLabel"
                                                                style="font-family: cairo;">تعديل  الرسائل</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="card-body">
                                                                <form action="{{ route('message.update', $item->id) }}"
